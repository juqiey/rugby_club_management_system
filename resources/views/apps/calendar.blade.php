...
@section('script')
    <!-- calendar min js -->
    <script src="{{ URL::to('assets/libs/fullcalendar/index.global.min.js') }}"></script>
    <script src="{{ URL::to('assets/js/pages/apps-calendar.init.js') }}"></script>
@endsection
@endsection