...
@section('content')
    ...
    <!-- End Page-content -->
@section('script')
    <script src="{{ asset('assets/js/pages/invoice-create.init.js') }}"></script>
@endsection
@endsection